...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-dnd/node_modules/react-dnd/lib/DragDropContextProvider.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-dnd/node_modules/react-dnd/lib/DragDropContextProvider.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-dnd/node_modules/react-dnd/lib/</a> &#187; DragDropContextProvider.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function DragDropContextProvider(props, context) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, DragDropContextProvider);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (DragDropContextProvider.__proto__ || Object.getPrototypeOf(DragDropContextProvider)).call(this, props, context));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.backend = (0, _DragDropContext.unpackBackendForEs5Users)(props.backend);</span>
...
&nbsp;
       ...
       */
<span class="cstat-no" title="statement not covered" >      var getWindow = <span class="fstat-no" title="function not covered" >function getWindow() {</span></span>
<span class="cstat-no" title="statement not covered" >        if (_this2.props &amp;&amp; _this2.props.window) {</span>
<span class="cstat-no" title="statement not covered" >          return _this2.props.window;</span>
        } else <span class="cstat-no" title="statement not covered" >if (_this2.context &amp;&amp; _this2.context.window) {</span>
<span class="cstat-no" title="statement not covered" >          return _this2.context.window;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return (0, _DragDropContext.createChildContext)(this.backend, { window: getWindow() });</span>
    }
  }, {
    key: 'render',
